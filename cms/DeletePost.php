...
if (isset($_POST["submit"])) {
  ...
  $post=$_POST["Post"];
      ...
      mysqli_query($link,"DELETE FROM admin_panel WHERE id='$DeleteFromUrl'");
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-10">
          ...
          <div>
            <?php
            $EditQueryParamiter=$_GET['Delete'];
            ...
            while ($row=mysqli_fetch_array($res)) {
             ...
             ?>
            <form action="DeletePost.php?Delete=<?php echo $EditQueryParamiter; ?>" method="post" enctype="multipart/form-data">
              <fieldset>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <!-- <input disabled type="file" name="Image" id="imageselect" class="form-control"> -->
                </div>
                <div class="form-group">
                  <label for="postarea"> Post: </label>
                  <textarea disabled name="Post" id="postarea" class="form-control" rows="8" cols="80" ><?php echo $PostToBeUpdated ?>"</textarea>
                </div>
                <br>
